...
const ModalStats = ({ openStats, setOpenStats }) => {
  return (
    <div
      className={`overlay animated ${openStats ? "show" : ""}`}
    ...
    >
      <div className="modal" onClick={(e) => e.stopPropagation()}>
        ...
        <div className="stats">
          ...
          <div className="statContainer">
            <div className="statProp">
              {(
                (parseInt(localStorage.getItem("goodGames")) /
                  parseInt(localStorage.getItem("totalGames"))) *
                  100 || 100
              ).toPrecision(3)}
              %
            </div>
